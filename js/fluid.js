...
var Canvas = function () {
    ...
    _createClass(Canvas, [{
        ...
        value: function triggerWave(x, y) {
            ...
            for (var n = 0; n < points.length; n++) {if (window.CP.shouldStopExecution(2)){break;}
                var p = points[n];
...
window.CP.exitedLoop(2);
            ...
            for (var _n = 0; _n < length; _n++) {if (window.CP.shouldStopExecution(3)){break;}
...
window.CP.exitedLoop(3);
        ...
        value: function drawCurve() {
            ...
            for (var n = 0; n < this.wave.points.length - 1; n++) {if (window.CP.shouldStopExecution(4)){break;}
...
window.CP.exitedLoop(4);
        ...
        value: function updateWave() {
            ...
            for (var n = 0; n < points.length; n++) {if (window.CP.shouldStopExecution(5)){break;}
                var p = points[n];

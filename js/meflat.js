$(document).ready(function() {
	...
	scene1TL
		.to($('#who #about-me-wrapper'), 1, {autoAlpha: 0, ease:Power1.easeNone, display: 'none', bottom: 400}, 1.5)
		.to($('#who #test-wrapper'), 1, {autoAlpha: 1, ease:Power1.easeNone, display: 'block', bottom: 400}, 1.5);

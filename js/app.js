...
$(document).ready(function() {
	...
	*/
	...
	whatTween
		...
		.to($("#marble-chrome-wrapper"), 1, {ease: Power1.easeInOut, yPercent:85, xPercent: -120, scale:1.3}, 0)
		.to($("#marble-iphone-wrapper"), 1, {ease: Power1.easeInOut, yPercent:65, xPercent: 150, scale:1.4}, 0);

...
$(document).ready(function() {
	...
	*/
	...
	whatTween
		...
		.to($("#marble-chrome-wrapper"), 1, {ease: Power1.easeInOut, top:"60%", left:"0%", scale:1.3}, 0)
		.to($("#marble-iphone-wrapper"), 1, {ease: Power1.easeInOut, top:"60%", left:"100%", scale:1.4}, 0);

...
$(document).ready(function() {
	...
	*/
	...
	whatTween
		...
		.to($("#marble-chrome-wrapper"), 1, {ease: Power1.easeInOut, yPercent:82, left:"50%", scale:1.3}, 0)
		.to($("#marble-iphone-wrapper"), 1, {ease: Power1.easeInOut, yPercent:62, right:"50%", scale:1.4}, 0);
